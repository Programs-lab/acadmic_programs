...
5.times.each do |week|
  ...
  working_hour_thursday = WorkingHour.create(working_day_id: working_day_thursday.id, initial_hour: DateTime.parse("#{current_week[3].to_s} 06:00 -0500"), end_hour: DateTime.parse("#{current_week[3].to_s} 18:00 -0500"), procedure_type_ids: [procedure_type_2.id], procedure_type_kinds: ["procedimiento"])
