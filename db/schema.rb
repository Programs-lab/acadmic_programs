...
ActiveRecord::Schema.define(version: 2020_06_11_214120) do
  ...
  create_table "comments", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "procedure_document_id"
    t.string "content", default: ""
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["procedure_document_id"], name: "index_comments_on_procedure_document_id"
  ...
  create_table "procedure_documents", force: :cascade do |t|
    ...
    t.date "last_uploaded_file_date"
